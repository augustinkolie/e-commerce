...
const NewArrivals = () => {
    ...
    useEffect(() => {
        const fetchNewArrivals = async () => {
            try {
                ...
                // Filter for products with 'Nouveau' badge
                const newItems = data.filter(p => p.badge === 'Nouveau');
    ...
    if (loading) return <div className="text-center py-20 dark:text-white">Chargement des nouveautés...</div>;
            ...
            <div className="max-w-7xl mx-auto">
                <div className="flex items-center justify-between mb-8">
                    <h1 className="text-3xl font-bold text-gray-900 dark:text-white flex items-center gap-2">
                        <span className="text-green-500">✨</span> Nouveautés
                    </h1>
                    <span className="text-gray-500 dark:text-gray-400">{products.length} articles récents</span>
                </div>
